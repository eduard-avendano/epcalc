...
<div class="chart" style="display: flex; max-width: 1120px">
  ...
  <div style="flex: 0 0 270px; width:270px;">
    <div style="position:relative; top:48px; right:-115px">
      <div class="legendtext" style="position:absolute; left:-16px; top:-34px; width:50px; height: 100px; font-size: 13px; line-height:16px; font-weight: normal; text-align: center"><b>Día</b><br> {Math.round(indexToTime(active_))}</div>
      ...
      <div style="position:absolute; left:0px; top:0px; width: 180px; height: 100px">
        ...
        <div class="legend" style="position:absolute;">
          ...
          <div class="legendtextnum"><span style="font-size:12px; padding-right:2px; color:#CCC">Δ</span> <i>{formatNumber(Math.round(N*get_d(active_)[0]))} / día</i>
                                 </div>
          </div>
        </div>
          <div class="legendtext" style="text-align: right; width:105px; left:-111px; top: 4px; position:relative;">Población no inmune a la enfermedad.</div>
      ...
      <div style="position:absolute; left:0px; top:{legendheight*1}px; width: 180px; height: 100px">
        ...
        <div class="legend" style="position:absolute;">
          ...
          <div class="legendtextnum"><span style="font-size:12px; padding-right:2px; color:#CCC">Δ</span> <i>{formatNumber(Math.round(N*get_d(active_)[1])) } / día</i>
                                 </div>
          </div>
        </div>
        <div class="legendtext" style="text-align: right; width:105px; left:-111px; top: 4px; position:relative;">Población actualmente en incubación.</div>
      ...
      <div style="position:absolute; left:0px; top:{legendheight*2}px; width: 180px; height: 100px">
        ...
        <div class="legend" style="position:absolute;">
          <div class="legendtitle">Contagiosos</div>
          <div style="padding-top: 5px; padding-bottom: 1px">
      ...
      <div style="position:absolute; left:0px; top:{legendheight*3}px; width: 180px; height: 100px">
        ...
        <div class="legend" style="position:absolute;">
          <div class="legendtitle">Retirados</div>
          ...
          <div class="legendtextnum"><span style="font-size:12px; padding-right:2px; color:#CCC">Δ</span> <i>{formatNumber(Math.round(N*(get_d(active_)[3]+get_d(active_)[4]+get_d(active_)[5]+get_d(active_)[6]+get_d(active_)[7]) )) } / día</i>
                                 </div>
          </div>
        </div>
        <div class="legendtext" style="text-align: right; width:105px; left:-111px; top: 4x; position:relative;">Población que ya no es infecciosa por aislamiento o inmunidad.</div>
      ...
      <div style="position:absolute; left:0px; top:{legendheight*4+14-3}px; width: 180px; height: 100px">
        ...
        <div class="legendtext" style="text-align: right; width:105px; left:-111px; top: 8px; position:relative;">Completamente recuperados.</div>
      ...
      <div style="position:absolute; left:0px; top:{legendheight*4+57}px; width: 180px; height: 100px">
        ...
        <div class="legend" style="position:absolute;">
          ...
          <div class="legendtextnum"><span style="font-size:12px; padding-right:2px; color:#CCC">Δ</span> <i>{formatNumber(Math.round(N*(get_d(active_)[5]+get_d(active_)[6]))) } / día</i>
                                 </div>
        </div>
        <div class="legendtext" style="text-align: right; width:105px; left:-111px; top: 10px; position:relative;">Hospitalizaciones activas.</div>
      ...
      <div style="position:absolute; left:0px; top:{legendheight*4 + 120+2}px; width: 180px; height: 100px">
        ...
        <div class="legend" style="position:absolute;">
          <div class="legendtitle">Fatalidad</div>
          <div style="padding-top: 3px; padding-bottom: 1px">          
          ...
          <div class="legendtextnum"><span style="font-size:12px; padding-right:2px; color:#CCC">Δ</span> <i>{formatNumber(Math.round(N*get_d(active_)[9])) } / día</i>
                                 </div>
          </div>
        </div>
      ...
      <div style="position: absolute; width:{width+15}px; height: {height}px; position: absolute; top:100px; left:10px; pointer-events: none">
       ...
       <!-- <span style="font-size: 13px">{@html math_inline("\\mathcal{R}_t=" + (R0*InterventionAmt).toFixed(2) )}</span> ⟶ -->
        ...
        <div id="interventionDrag" class="legendtext" style="flex: 0 0 160px; width:120px; position:relative;  top:-70px; height: 60px; padding-right: 15px; left: -125px; pointer-events: all;cursor:col-resize;" >
          <div class="paneltitle" style="top:9px; position: relative; text-align: right">Intervención en el día {format("d")(InterventionTime)}</div>
      ...
      <div style="position: absolute; width:{width+15}px; height: {height}px; position: absolute; top:120px; left:10px; pointer-events: none">
        <div style="
            ...
            <div style="flex: 0 0 160px; width:200px; position:relative; top:-125px; left: 1px" >
              ...
              <div class="paneldesc">para disminuir la transmisión<br></div>
              </div>
...
<div style="height:220px;">
  ...
  <div class = "row">
    ...
    <div class="column">
      ...
      <div class="paneldesc" style="height:29px; border-top: 1px solid #EEE; padding-top: 10px">Tiempo desde el final de incubación hasta la muerte.<br></div>
    ...
    <div class="column">
      ...
      <div class="paneldesc" style="height:30px">Duración de hospitalización.<br></div>
      ...
      <div class="paneldesc" style="height:29px; border-top: 1px solid #EEE; padding-top: 10px">Tiempo de recuperación de casos leves<br></div>
    ...
    <div class="column">
      <div class="paneltitle">Estadísticas de cuidados</div>
...
<p class="center">
Basado en <a href="https://gabgoh.github.io/COVID/index.html">epcalc</a>. 
</p>
...
<div style="margin-bottom: 30px">
  ...
  <div class="center" style="padding: 10px; margin-top: 3px; width: 925px">
    ...
    <form>
      <textarea type="textarea" rows="2" cols="5000" style="white-space: nowrap;  overflow: auto; width:100%; text-align: left" id="fname" name="fname">{state}</textarea>
    </form>
  </div>
</div>
